...
class BloggerController extends Controller
{
    ...
    {
        return view('backend.user.bloggers');
    }

    public function bloggersData()
    {
        $data = Blogger::latest()->get();
    ...
    {
        $data = Blogger::latest()->get();
        return response()->json(array('error'=> '', 'user' => $data));
    }
}
