...
@section('content') 
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title">Add Admin</h1>
                </div>
    ...
    <div id="editmodal" class="modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title">Edit Admin</h1>
                </div>
                <div class="modal-body">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            type:"POST",
            ajax: {
              url: "{{ url('api/'.session()->get('role').'/get-admins-data')}}",
            ...
            $("#addform").submit(function(e) {
                ...
                var actionurl = "{{ url('api/'.session()->get('role').'/add-admin')}}";
            ...
            $(document).on("click",'.edit',function(){
                ...
                var actionurl = "{{ url('api/'.session()->get('role').'/get-admin')}}";
                //do your own request an handle the results
                $.ajax({
                url: actionurl,
                type: 'post',
            ...
            $("#editform").submit(function(e) {
                ...
                //get the action-url of the form
                var actionurl = "{{ url('api/'.session()->get('role').'/update-admin')}}";
                //do your own request an handle the results
                $.ajax({
                url: actionurl,
                type: 'post',
            ...
            $(document).on("click",'#confirmDel',function(){
                ...
                var actionurl = "{{ url('api/'.session()->get('role').'/delete-admin')}}";
                //do your own request an handle the results
                $.ajax({
                url: actionurl,
                type: 'post',
