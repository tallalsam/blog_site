...
@section('content') 
    ...
    <script type="text/javascript">
        $(function () {
            ...
            type:"POST",
            ajax: {
              url: "{{ url('api/'.session()->get('role').'/get-users-data')}}",
            ...
            $("#addform").submit(function(e) {
                ...
                var actionurl = "{{ url('api/'.session()->get('role').'/add-user')}}";
            ...
            $(document).on("click",'.edit',function(){
                ...
                var actionurl = "{{ url('api/'.session()->get('role').'/get-user')}}";
                //do your own request an handle the results
                $.ajax({
                url: actionurl,
                type: 'post',
            ...
            $("#editform").submit(function(e) {
                ...
                //get the action-url of the form
                var actionurl = "{{ url('api/'.session()->get('role').'/update-user')}}";
                //do your own request an handle the results
                $.ajax({
                url: actionurl,
                type: 'post',
            ...
            $(document).on("click",'#confirmDel',function(){
                ...
                var actionurl = "{{ url('api/'.session()->get('role').'/delete-user')}}";
                //do your own request an handle the results
                $.ajax({
                url: actionurl,
                type: 'post',
